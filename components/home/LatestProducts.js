	...
	return (
		<div class='top-seller'>
			<div class='products__top iflx-center'>
				<p class='products__top--title'>Latest Products</p>
				<div class='products__top--buttons iflx-center'>
					<div class='prev-icon'>
						<svg class='prev-icon-disabled' width='24' height='24'>
							<use href='/uploads/icon-sprite.svg#prev-icon-disabled'></use>
						</svg>
					</div>
					<div class='next-icon'>
						<svg class='next-icon-abled' width='24' height='24'>
							<use href='/uploads/icon-sprite.svg#next-icon-abled'></use>
						</svg>
					</div>
				</div>
			</div>
